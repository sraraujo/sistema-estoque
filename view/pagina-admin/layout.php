...
<head>
    ...
    <meta property="og:description" content="Sistema de gestão e estoque para axuliar na sua empresa <?= $titulo ?>"/>
...
<body class="sb-nav-fixed">
    ...
    <script src="view/assets/js/datatables-simple-demo.js"></script>

            ...
            <form action="model/clientes.php" method="post">
                        ...
                        <div class="col-sm-12 col-md-6 mb-3">
                            <div class="mb-3">
                                <h5>
                                    ...
                                    <input type="date" class="form-control" id="dataNasc" name="dataNasc" placeholder1="Codigo do Produto" maxlength="60">
                                </h5>
                            </div>
                        </div>
                        <!-- endereço -->
                        <div class="col-sm-12 col-md-6 mb-3">
                            <div class="mb-3">
                                <h5>
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="endereco" placeholder1="Codigo do Produto" maxlength="100" required>
                                </h5>
                            </div>
                        </div>
                        <!-- bairro -->
                        <div class="col-sm-12 col-md-6 mb-3">
                            <div class="mb-3">
                                <h5>
                                    ...
                                    <input type="text" class="form-control" id="bairro" name="bairro" placeholder1="Codigo do Produto" maxlength="40" required>
                                </h5>
                            </div>
                        </div>
                        <!-- e-mail -->
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="mb-3">
                                <h5>
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" placeholder1="Codigo do Produto" maxlength="60" required>
                                </h5>
                            </div>
                        </div>
                        <!-- whatsapp -->
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="mb-3">
                                <h5>
                                    ...
                                    <input type="text" class="form-control estoque" id="whatsapp" name="whatsapp" placeholder1="Estoque do Produto" required>
                                </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-3 mb-0 text-center">
                    ...
                    <button class="btn btn-primary " type="submit">
                        <input type="hidden" name="cliente" value="novo">
